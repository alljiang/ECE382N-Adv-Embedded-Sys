...
`timescale 1 ns / 1 ps
	...
	module AXI4_BURST_MASTER_v1_0_M00_AXI #
	(
		...
		parameter  C_M_TARGET_SLAVE_BASE_ADDR	= 32'hFFFC0000,
	...
	(
        ...
        input wire [31:0] m_address,         // This is the address to burst to eventually.
        input wire [7:0]  m_burst_length,
	...
	// Update value to 4'b0011 if coherent accesses to be used
	// via the Zynq ACP port. Not Allocated, Modifiable, not Bufferable. 
	// Not Bufferable since this example is meant to test memory, not intermediate cache. 
	...
	// by burst_size_byte to point to the next address. 
	  ...
	  begin                                                                
	    ...
	    if (M_AXI_ARESETN == 0 || init_txn_pulse == 1'b1 )   // Wait for pulse                                        
	      begin                                                            
	        axi_awvalid <= 1'b0;                                           
	      end                                                              
	...
	// Modfify this for user application
